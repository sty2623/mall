...
pluralCaseList.push( {plural: "deliveryMgmts", pascal: "DeliveryMgmt"} )

pluralCaseList.push( {plural: "inventoryMgmts", pascal: "InventoryMgmt"} )

pluralCaseList.push( {plural: "orderMgmts", pascal: "OrderMgmt"} )
